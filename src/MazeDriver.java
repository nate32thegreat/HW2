 ...
 * 	We intentionally share the memory location of the maze with the robot.
 ...
 ï	In the first line:  two integers (the number of rows and columns, respectively,  in the maze)
 ï	In the second line:  two integers (the row and column locations, respectively, of the Start cell
 ï	In the third line:  two integers (the row and column locations, respectively, of the Exit cell
 ï	Each line thereafter will contain characters appearing in one row of the maze.
